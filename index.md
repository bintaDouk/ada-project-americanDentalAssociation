...
{% raw %}
<iframe class="toggle-frame" src="images\Q2\countries_carousel.html" width="900px" height="700px" frameborder="0" position="relative" id="positive" style="display: block;">positive barplot</iframe>
{% endraw %}
